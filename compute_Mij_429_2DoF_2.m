function [Mij_429,delta_Mij_thetak_429,Cij_429,Ck,Gamma_ijk] = compute_Mij_429_2DoF_2(xi_ai, exp_ai, Pi, gsli0, Mi_b, theta_dot)
...
for c_i=1:i
    for c_j=1:j
        ...
        l = max(c_i,c_j);
        for add=l:n_Dof
            [Aij_1] = compute_Aij_for_Ji_427_2DoF(exp_ai, Pi, add, c_i);
            [Aij_2] = compute_Aij_for_Ji_427_2DoF(exp_ai, Pi, add, c_j);
        ...
        for k=1:n_Dof
            ...
            [delta_Mij_thetak_429(c_i,c_j,k)] = compute_delta_Mij_thetak_429_2DoF_2(xi_ai, exp_ai, Pi, gsli0, Mi_b, c_i,  c_j,   k);
            [delta_Mik_thetaj_429(c_i,c_j,k)] = compute_delta_Mij_thetak_429_2DoF_2(xi_ai, exp_ai, Pi, gsli0, Mi_b, c_i,  k  , c_j);
            [delta_Mkj_thetai_429(c_i,c_j,k)] = compute_delta_Mij_thetak_429_2DoF_2(xi_ai, exp_ai, Pi, gsli0, Mi_b,   k,  c_j, c_i);
