function dJS = dotJs_Sanchez(Js,qdot)
% Calculates the first time derivative of Spatial Jacobian for 3 DoF serial
% manipulator
...
% dotJs_Sanchez = [dxi1 dxi2 dxi3 dxi4 dxi5 dxi6];
dJS = [dxi1 dxi2 dxi3];
